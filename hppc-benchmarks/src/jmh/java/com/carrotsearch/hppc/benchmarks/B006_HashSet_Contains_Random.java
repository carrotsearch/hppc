...
public class B006_HashSet_Contains_Random {
  @Param("0.75")
  ...
  public void prepare() {
    ...
    ops = library.newIntSet(keyCount, loadFactor);
  ...
  public Object contains() {
    final IntSetOps ops = this.ops;
    final XorShift128P rnd = this.rnd;
    final int randomRange = this.randomRange;
    int v = 0;
    for (int i = 0, numLoops = 20_000_000; i < numLoops; i++) {
      if (ops.contains(rnd.nextInt(randomRange))) {
        v++;
      }
    }
    return v;
  ...
  public static void main(String[] args) throws RunnerException {
    Options opt = new OptionsBuilder().include(B006_HashSet_Contains_Random.class.getSimpleName())
