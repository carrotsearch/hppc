 ...
 */
public class BitUtil_pop3264 {
  private final static byte [] bcounts = new byte [0x10000];
  static
  {
  ...
  /** Returns the number of bits set in the long (32-bit architectures) */
  public static int pop_32(long v) {
    int t;
    return 
  ...
  /** Returns the number of bits set in the long (64-bit architectures) */
  public static int pop_64(long x) {
