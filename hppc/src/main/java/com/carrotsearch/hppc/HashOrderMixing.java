...
/**
 * Factory methods to acquire the most common types of {@link HashOrderMixingStrategy}.
 *
...
public final class HashOrderMixing {
  ...
  /**
   * Returns a randomized {@link HashOrderMixingStrategy} that issues unique per-container seed.
   * This minimizes the chances of hash distribution conflicts.
   */
  ...
  /**
   * A constant {@link HashOrderMixingStrategy}. This is useful if one needs to have deterministic
  ...
  /**
   * Deterministic {@link HashOrderMixingStrategy} will reorder keys depending on the size of the
   * container's buffer.
   *
   * <p>This is inherently unsafe with hash containers using linear conflict addressing. The only
   * use case when this can be useful is to count/ collect unique keys (for which scatter tables
   * should be used).
   *
  ...
  /**
   * This strategy does not change the hash order of keys at all. This is inherently unsafe with
   * hash containers using linear conflict addressing. The only use case when this can be useful is
   * to count/ collect unique keys (for which scatter tables should be used).
   *
   * @deprecated Permanently deprecated as a warning signal.
   */
  @Deprecated
