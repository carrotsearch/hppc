...
public final class BitMixer {
  ...
  public static int mixPhi(byte k, int seed) {
    final int h = (k ^ seed) * PHI_C32;
    return h ^ (h >>> 16);
  }
  ...
  public static int mixPhi(char k, int seed) {
    final int h = (k ^ seed) * PHI_C32;
    return h ^ (h >>> 16);
  }
  ...
  public static int mixPhi(short k, int seed) {
    final int h = (k ^ seed) * PHI_C32;
    return h ^ (h >>> 16);
  }
  ...
  public static int mixPhi(int k, int seed) {
    final int h = (k ^ seed) * PHI_C32;
    return h ^ (h >>> 16);
  }
  ...
  public static int mixPhi(float k, int seed) {
    final int h = (Float.floatToIntBits(k) ^ seed) * PHI_C32;
    return h ^ (h >>> 16);
  }
  ...
  public static int mixPhi(double k, int seed) {
    final long h = (Double.doubleToLongBits(k) ^ seed) * PHI_C64;
    return (int) (h ^ (h >>> 32));
  }
  ...
  public static int mixPhi(long k, int seed) {
    final long h = (k ^ seed) * PHI_C64;
    return (int) (h ^ (h >>> 32));
  }
  ...
  public static int mixPhi(Object k, int seed) {
