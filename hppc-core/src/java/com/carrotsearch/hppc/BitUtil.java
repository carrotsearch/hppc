...
package com.carrotsearch.hppc; // from org.apache.solr.util rev 555343
...
final class BitUtil {
  ...
  /** Returns the number of bits set in an int. */
  ...
  /** Returns the number of bits set in the long */
  public static int pop_orig(long x) {
